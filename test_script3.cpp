...
void Shell::run() {
    ...
    std::cout << "Formatting and creating some test files (f1,f2)..."
              << std::endl;
    ...
    if (ret_val)
        std::cout << "Error: mkdir(d1) " << arg1 << " failed, error code "
                  << ret_val << std::endl;
    ...
    ret_val = filesystem.mkdir(arg1);
    if (ret_val)
        std::cout << "Error: mkdir " << arg1 << " failed, error code "
                  << ret_val << std::endl;
    ...
    if (ret_val)
        std::cout << "Error: pwd failed in root directory, error code "
                  << ret_val << std::endl;
    ...
    if (ret_val)
        std::cout << "Error: cd " << arg1 << " failed, error code " << ret_val
                  << std::endl;
    std::cout << "Expected output:" << std::endl;
    ...
    if (ret_val)
        std::cout << "Error: cat " << arg1 << " failed, error code " << ret_val
                  << std::endl;
    PRINTDIV2;

    std::cout << "Checking that cp works with a directory as destination"
              << std::endl;
    ...
    if (ret_val)
        std::cout << "Error: cp(" << arg1 << "," << arg2
                  << ") failed, error code " << ret_val << std::endl;
    arg1 = "d1";
    ret_val = filesystem.cd(arg1);
    if (ret_val)
        std::cout << "Error: cd " << arg1 << " failed, error code " << ret_val
    ...
    std::cout << "Checking that mv works with a directory as destination"
              << std::endl;
